...
/** Derive a display filename from a stored file.path (may be a Windows path with backslashes). */
                    ...
                    <div style={{display: "flex", flexDirection: "column", gap: 14}}>
                        {timeline.map(v => {
                            /* Per-video scale: lane right edge = last appearance. Each appearance is
                               ...
                               that scale. We don't have the source's true duration, so the lane shows
                               "from beginning to last appearance," not the whole video. */
